...
const ServicePage = () => {
  ...
  return (
    <section className="flex flex-col gap-4">
      <BreadcrumbsComponent items={[{ name: "Serviços de recurso", href: "/services" }, { name: pathname.split("/")[2], href: "/" }]} />
      <TabsComponent items={[{ name: "Visão Geral", key: "general", content: <OverviewCardComponent columns={columns} rows={rows} data={data} /> }, { name: "Pipeline", key: "pipeline", content: <div>Conterá um data flow como no exemplo da primeira pagina</div> }, { name: "Materialização", key: "materialization", content: <ServiceMaterializationCards /> }, {
        name: "Monitoramento", key: "monitoring", content:
          <>
      ...
      }, { name: "Dataset", key: "dataset", content: <div>Conteudo do dataset</div> }]} />
    </section>
  )
}
