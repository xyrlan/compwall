...
const MonitoringPage = () => {
  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      <TabsComponent items={[
        {
          name: "Monitoramento de recursos", key: "general", content:
            <>
                ...
                <CardBody className="flex flex-row gap-4 justify-evenly py-20">
                  ...
                  <div className='flex flex-row justify-center items-center gap-40'>
                    <div className='flex flex-col gap-2 text-center'>
                      ...
                      <label className="block text-sm font-bold text-gray-800">Total</label>
                    </div>
                    <div className='flex flex-col gap-2 text-center'>
                      <p className='text-5xl font-bold'>3</p>
                      <label className="block text-sm font-bold text-gray-800">Materializados</label>
                    </div>
                  </div>

                  <div className='flex items-center font-medium'>Grafico com o número de visualizações de recursos e tabelas</div>
        ...
        {
          name: "Monitoramento SLO", key: "slo", content:
            <>
              <CardCharts title={"Recurso de atendimento ao SLO de confiabilidade"}>
                <GenericLineChart
                  data={queryLatencyData}
                ...
                <div className='flex flex-col gap-2 text-center justify-center'>
                  ...
                  <label className="block text-sm font-bold text-gray-800">SLO de confiabilidade (30 dias)</label>
                </div>
              </CardCharts>
              <CardCharts title={"Recurso de atendimento ao SLO de latência"}>
                ...
                <div className='flex flex-col gap-2 text-center justify-center'>
                  <p className='text-5xl font-bold'>100%</p>
                  <label className="block text-sm font-bold text-gray-800">SLO de latência (30 dias)</label>
                </div>
              </CardCharts>
            </>
        ...
        {
          name: "Monitoramento de recurso do servidor", key: "server", content:
            <>
        ...
        {
          name: "Monitoramento da nuvem", key: "cloud", content:
            <>
